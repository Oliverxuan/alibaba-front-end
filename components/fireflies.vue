<template>
	<view class="checkbox-father" @click="onclickfireflies">
		<view class="checkbox-wrap">
			<view class="abdomen" :class="[bdcOrange?'bdcOrange':'']">
				<view class="thorax">
					<view class="head">
						<view class="eyes"></view>
						<view class="antennae"></view>
					</view>
				</view>
				<view class="wings">
					<view class="wing wing-a" :class="[bdcOrange?'wing-ao':'']"></view>
					<view class="wing wing-b" :class="[bdcOrange?'wing-bo':'']"></view>
				</view>
			</view>
			</label>
		</view>
